package br.com.fiap.api_patient.framework.advice;

import br.com.fiap.api_patient.core.exception.*;
import br.com.fiap.api_patient.framework.dto.response.ErrorResponse;
...
public class ApplicationExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePatientAlreadyExistsException(
            PatientAlreadyExistsException message,
            HttpServletRequest request
    ) {
        HttpStatus status = HttpStatus.CONFLICT;
