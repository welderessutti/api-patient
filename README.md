...
**Endpoint:** ``/api/patient/{clientId}`` ``/api/patient?email=`` ``/api/patient/all``
...
```bash
git clone https://github.com/welderessutti/patient-management-ms.git
```

Caso não queira clonar o repositório, você pode baixá-lo
em [GitHub](https://github.com/welderessutti/patient-management-ms).
...
do [Docker Hub](https://hub.docker.com/repository/docker/welderessutti/patient-management-ms/general), caso ele não
